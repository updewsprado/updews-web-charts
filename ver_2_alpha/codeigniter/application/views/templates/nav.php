        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/">DEWS Landslide (ALPHA Development)</a>
            </div>
            <!-- Top Menu Items -->
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                	<li <?php echo $monitoring; ?> >
                        <a href="<?php echo base_url(); ?>monitoring"><i class="fa fa-fw fa-th"></i> Monitoring</a>
                    </li>
                    <li <?php echo $dropdown_chart; ?> >
                        ...
                        <ul id="dropdown_chart" class="collapse">
                            <li>
                                <a href="<?php echo base_url(); ?>site">Site Level</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>node">Node Level</a>
                            </li>
                        </ul>
                    </li>
